...
readcell granIII_fabio.p /cell -hsolve 
...
Enmda= {{R*T}/F}*{log {a}}
setfield /cell/periph22[9]/head[9]/AMPA_NMDA Ek Enmda
setfield /cell/periph21[7]/head[7]/AMPA_NMDA Ek Enmda
setfield /cell/periph12[10]/head[10]/AMPA_NMDA Ek Enmda
setfield /cell/periph11[12]/head[12]/AMPA_NMDA Ek Enmda

V={getfield /cell/periph22[9]/head[9] Vm}
f={Caout}/{Caout+{1/PCaPM}*{M/4}*{1-{exp {2*V*F/{R*T}}}}}
setfield /cell/periph22[9]/head[9]/AMPA_NMDA/Ca_fraction x {f}

V={getfield /cell/periph21[7]/head[7] Vm}
f={Caout}/{Caout+{1/PCaPM}*{M/4}*{1-{exp {2*V*F/{R*T}}}}}
setfield /cell/periph21[7]/head[7]/AMPA_NMDA/Ca_fraction x {f}

V={getfield /cell/periph12[10]/head[10] Vm}
f={Caout}/{Caout+{1/PCaPM}*{M/4}*{1-{exp {2*V*F/{R*T}}}}}
setfield /cell/periph12[10]/head[10]/AMPA_NMDA/Ca_fraction x {f}

V={getfield /cell/periph11[12]/head[12] Vm}
f={Caout}/{Caout+{1/PCaPM}*{M/4}*{1-{exp {2*V*F/{R*T}}}}}
setfield /cell/periph11[12]/head[12]/AMPA_NMDA/Ca_fraction x {f}
end
...
addmsg /presyn /cell/periph22[9]/##[][TYPE=synchan] ACTIVATION z
addmsg /presyn /cell/periph21[7]/##[][TYPE=synchan] ACTIVATION z
addmsg /presyn /cell/periph12[10]/##[][TYPE=synchan] ACTIVATION z
addmsg /presyn /cell/periph11[12]/##[][TYPE=synchan] ACTIVATION z
...
//Ploting variables
addmsg /cell/periph11[12]/head[]/AMPA_NMDA/NMDA /data2/conductance PLOT Gk *GNMDA *green
addmsg /cell/periph11[12]/head[]/AMPA_NMDA /data2/conductance PLOT Gk *GAMPA *red
